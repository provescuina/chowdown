...
'''path_recipes = "/home/pi/receptari/_recipes/"
path_images = "/home/pi/receptari/images/"'''

path_images = "./images/"
path_recipes = "./_recipes/"

def generateRecipeFile(email_content, fileName):
    global recepta, path_recipes
    content = email_content.splitlines()
    recipe_name = content[0][19:]
    recepta = recipe_name
    tags = content[1][11:]
    author = content[2][7:]
    path = os.path.join(path_recipes, recipe_name + ".md")
    ...
    f.write("From " + author + "\n")
    f.close()
    os.chmod(path_recipes + recipe_name + ".md", 0o777)
        ...
        for part in email_message.walk():
            ...
            if bool(fileName):
                ...
                if not os.path.isfile(filePath) :
                    ...
                    fp.close( )
                    os.chmod(path_images + fileName, 0o777)
                    new_image = True
                    image_name = fileName
